...
function RightPanel() {
    ...
    return (_jsxs(Drawer, Object.assign({ variant: "permanent", open: true }, { children: [_jsx(BreadCrumb, { levelOneName: cms.state.selectedComponent
                ...
                } }), rightOpenedMenu && (_jsxs("div", { children: [rightOpenedMenu === ERightMenus.MAPPED_COMPONENTS && (_jsx(MappedComponents, {})), rightOpenedMenu === ERightMenus.FIELD_PROPS && (_jsx(ComponentPropsForm, {})), rightOpenedMenu.includes(ERightMenus.VALIDATIONS) && (_jsx(FormComponentFeatures, { feature: "validations", events: [
