...
function RightPanel() {
    ...
    return (_jsxs(Drawer, Object.assign({ variant: "permanent", open: true }, { children: [_jsx(BreadCrumb, { paths: (rightOpenedMenu === null || rightOpenedMenu === void 0 ? void 0 : rightOpenedMenu.split(".")) || [], onClick: (path) => {
                    ...
                    lastElement === path || setRightOpenedMenu(path);
                        ...
                        } })), rightOpenedMenu === ERightMenus.ERROR_MESSAGES && (_jsx(FormComponentFeatures, { feature: "errorMessages" })), rightOpenedMenu === ERightMenus.FILTERS && (_jsx(FormComponentFeatures, { feature: "filter" })), rightOpenedMenu.includes(ERightMenus.FORMATTERS) && (_jsx(FormComponentFeatures, { feature: "formatters", events: [
                            CoreEvents.ON_FIELD_MOUNT,
                            CoreEvents.ON_FIELD_CHANGE,
                            CoreEvents.ON_FIELD_FOCUS,
                            CoreEvents.ON_FIELD_MOUNT,
