...
const MappedComponents = () => {
    ...
    const dispatchNewComponentToSchema = (component) => cms.dispatch({
        type: ECMSActions.SET_BUILDER_SCHEMA,
        payload: {
            schema: schema.addToFormStep(cms.state.schema, component),
        },
    });
    return (_jsxs(Stack, Object.assign({ spacing: 3 }, { children: [_jsx(Divider, { children: "User mapped components" }), _jsx(Grid, Object.assign({ container: true, spacing: 2 }, { children: Object.keys(cms.mappings).map((key) => (_jsx(Grid, Object.assign({ item: true, xs: 6 }, { children: _jsx(FormProvider, Object.assign({ propsMapping: cms.propsMapping, mapper: cms.mappings }, { children: _jsx(ActionAreaCard, { preview: () => (_jsx(Form, { disable: true, schema: schema.addToFormStep(schema.initForm(), schema.buildComponent({
                                    component: key,
