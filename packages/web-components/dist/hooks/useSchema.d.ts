...
declare const useSchema: () => {
    ...
    createTemplate: (component: TComponent, isReference: boolean, name: string) => {
        ...
        rehydrate?: Partial<Record<import("@form-builder/engine/dist/core/events").EEVents.ON_FIELD_MOUNT | import("@form-builder/engine/dist/core/events").EEVents.ON_FIELD_CHANGE | import("@form-builder/engine/dist/core/events").EEVents.ON_FIELD_BLUR | import("@form-builder/engine/dist/core/events").EEVents.ON_FIELD_FOCUS | import("@form-builder/engine/dist/core/events").EEVents.ON_FIELD_REHYDRATE, import("@form-builder/engine/dist/core/types").TSchemaRehydrate>> | undefined;
